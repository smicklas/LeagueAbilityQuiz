          ...
          <div>
            ...
            <Modal isOpen={this.state.showModal && (this.state.numberOfQuestions == null)} contentLabel="Minimal Modal Example" className="modal" overlayClassName="overlay">    
              ...
              <div className="button-wrapper">
                <button className="primary-button" onClick={() => {this.dismissModal();}}> OK </button>  
              </div>
            </Modal>
            <Modal isOpen={this.state.showModal && !(this.state.numberOfQuestions == null)} 
            contentLabel="Minimal Modal Example" className="modal" overlayClassName="overlay">    
              <p>{this.state.feedbackMessage}</p>
